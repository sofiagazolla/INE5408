...
#ifndef STRUCTURES_LINKED_LIST_PUBLIC_H
#define STRUCTURES_LINKED_LIST_PUBLIC_H
...
class LinkedList {
 public:
    ...
    //! ...
    T& operator[](std::size_t index);  // acessar um elemento na posição index;
    //! ...
...
// private:  // tornado público para maior eficiência do hashing
